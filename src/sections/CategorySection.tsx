...
const categories = [
  ...
  },
  {
    id: 'cat-gelato',
    name: 'GELATO',
    sub: 'Authentic Italian creamery',
    icon: IceCream,
    link: '/menu?cat=cat-gelato',
    color: '#d4a017',
    gradient: 'from-[#d4a017]/20 to-transparent',
    img: 'https://media.istockphoto.com/id/503082763/photo/gelato-in-a-store-window.jpg?s=612x612&w=0&k=20&c=TkwBIPqSu4Q-BBVQjTxSpB4frO7Hd_tMSbJ8jpFIzRw=',
  },
  {
    id: 'cat-desserts',
    name: 'DESSERTS',
