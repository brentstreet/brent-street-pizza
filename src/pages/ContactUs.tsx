...
export default function ContactUs() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formState.name && formState.email && formState.message) {
      ...
      // Target phone number: +61 450 324 144
      const whatsappUrl = `https://wa.me/61450324144?text=${encodeURIComponent(message)}`;
          ...
          <div className="bg-[#F5EDE0] rounded-[20px] border border-[#E8D8C8] p-8 md:p-10">
            ...
            {!submitted ? (
              ...
              <div className="flex flex-col items-center gap-5 py-12 text-center">
                ...
                <h3 className="font-bebas text-[30px] text-[#1A1A1A] tracking-wider">Redirecting to WhatsApp!</h3>
                <p className="font-inter text-[14px] text-[#555555] max-w-xs text-center">Your message is ready to be sent. If a new window didn't open, please call us directly.</p>
                <a href={`tel:${global.phone || '0362724004'}`} className="font-bebas text-[28px] text-[#C8201A] tracking-wider hover:text-[#D4952A] transition-colors">
                  {global.phone_display || '03 6272 4004'}
                </a>
              </div>
