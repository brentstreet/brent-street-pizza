...
//               <ShieldAlert className="w-3 h-3 text-[#C8201A]" /> Brent Street
//               Pizza
//             </p>
//           </div>
//           <button
...
//                   <item.icon
//                     className={`w-5 h-5 ${isActive ? "text-white" : "text-[#D4952A] group-hover:scale-110 transition-transform"}`}
//                   />
...
//               </div>
//               <div>
//                 <p className="font-barlow text-[13px] font-700 uppercase tracking-wider text-white">
//                   Administrator
//                 </p>
...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: "Invoices", path: "/admin/invoices", icon: FileText },
    { name: "Product Catalog", path: "/admin/products", icon: Pizza },
    { name: "Deals & Combos", path: "/admin/deals", icon: Tag },
    { name: "App Content", path: "/admin/content", icon: ImageIcon },
    { name: "Categories", path: "/admin/categories", icon: Layout },
    { name: "Customizations", path: "/admin/customizations", icon: Sliders },
  ];
